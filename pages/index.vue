<template>
  <div class="h-screen w-full bg-[#0d0d0d] flex items-center justify-center flex-col space-y-4">
    <div class="flex items-center justify-center flex-col w-full space-y-2">
      <div class="w-1/3 space-x-10 flex flex-row justify-between pb-2 border-b-2 border-white">
    ...
    <div class="w-1/3 h-96 border-2 border-white flex items-center justify-center">
